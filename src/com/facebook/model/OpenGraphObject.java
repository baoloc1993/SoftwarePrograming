...
public interface OpenGraphObject extends GraphObject {
	 ...
	 *
	 * @param isScraped
	 *            true if the Open Graph object was created by scraping the Web,
	 *            false if not
	 */
	 ...
	 *
	 * @param createObject
	 *            true if the native Share dialog should create the object as
	 *            part of publishing an action, false if not
	 */
	@PropertyName(NativeProtocol.OPEN_GRAPH_CREATE_OBJECT_KEY)
	...
	final class Factory {
		 ...
		 *
		 * @param type
		 *            the Open Graph object type for the object, or null if it
		 ...
		 * @return an OpenGraphObject
		 */
		public static <T extends OpenGraphObject> T createForPost(
				Class<T> graphObjectClass, String type) {
		 ...
		 *            will be specified later
		 * @param title
		 *            the title of the object, or null if it will be specified
		 *            later
		 * @param imageUrl
		 *            the URL of an image associated with the object, or null
		 * @param url
		 *            the URL associated with the object, or null
		 * @param description
		 *            the description of the object, or null
		 * @return an OpenGraphObject
		 */
		public static <T extends OpenGraphObject> T createForPost(
				Class<T> graphObjectClass, String type, String title,
