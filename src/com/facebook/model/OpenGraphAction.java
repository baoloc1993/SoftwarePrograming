...
public interface OpenGraphAction extends GraphObject {
	 ...
	 * >Explicit Sharing</a> for more information.
	 *
	 ...
	 * href=
	 * "https://developers.facebook.com/docs/opengraph/guides/explicit-sharing/"
	 * >Explicit Sharing</a> for more information. You should only specify this
	 * property if explicit sharing has been enabled for an Open Graph action
	 * type.
	 *
	 * @param explicitlyShared
	...
	final class Factory {
		 ...
		 *
		 * @param type
		 *            the Open Graph action type for the action, or null if it
		 ...
		 *            the OpenGraphAction-derived type to return
		 * @return an OpenGraphAction
		 */
		public static <T extends OpenGraphAction> T createForPost(
