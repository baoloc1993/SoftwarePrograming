...
public class RequestBatch extends AbstractList<Request> {
	...
	/**
	 * Specifies the interface that consumers of the RequestBatch class can
	 * implement in order to be notified when the batch makes progress. The
	 * frequency of the callbacks can be controlled using
	...
	public interface OnProgressCallback extends Callback {
		 ...
		 * @param max
		 *            the max (target) value of the progress
		 */
