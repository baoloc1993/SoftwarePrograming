...
abstract public class PlatformServiceClient implements ServiceConnection {
	...
	public PlatformServiceClient(Context context, int requestMessage,
			int replyMessage, int protocolVersion, String applicationId) {
	...
	public boolean start() {
		...
		int availableVersion = NativeProtocol
				.getLatestAvailableProtocolVersionForService(context,
						protocolVersion);
